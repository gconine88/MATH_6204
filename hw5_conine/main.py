...
options assuming a stock price process with geometric brownian motion and .  
"""
...
call1 = round(amerOpt2.call(S, K, r, delta_t),6)
put1 = round(amerOpt2.put(S, K, r, delta_t), 6)
...
call2 = round(amerOpt2.call(S, K, r, delta_t), 6)
put2 = round(amerOpt2.put(S, K, r, delta_t), 6)
